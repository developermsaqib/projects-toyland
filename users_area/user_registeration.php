...
<body class="bg-light">
    ...
    <form action="" class="form-group w-50 m-auto" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline mb-4">
            ...
            <input type="text" name="user_zip_code" id="user_zip_code" class="form-control" placeholder="Enter Your Zip code/Postal Code" >
        </div>
        <!-- Submit Button -->
        <div class="form-outline mb-4">
            <input type="submit" name="user_register" value="Register" class="btn btn-info">
        </div>
        <p class="small">Already have an Account ? <a href="./user_login.php" class="text-danger"> Login</a></p>
    </form>
</div>
    <!-- bootstrap js link -->

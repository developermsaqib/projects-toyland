...
<head>
    ...
    <title>Toy Land || Product Details</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        if (isset($_GET['product_id'])) {
                            ...
                            $select_product_query = "SELECT * FROM `products` WHERE product_id = '$product_id' LIMIT 0,1";
                            ...
                            while ($result_row = mysqli_fetch_assoc($result_select_produt_query)) {
                                ...
                                $product_image2 = $result_row['product_image2'];
                                $product_image3 = $result_row['product_image3'];
                                $product_video = $result_row['product_video'];
                         ...
                         <div class='card'>
                            ...
                            <div class='card-body'>
                                ...
                                <p class='card-text p-1'>For $age Year Old</p>
                        ...
                        <div class='row'>
                            <div class='col-md-12'>
                                <h2 class='text-center text-info'>Related Images</h2>
                            </div>
                            <div class='col-md-4'>
                            <div class='card'>
                            ...
                            <div class='col-md-12'>
                                ...
                                <p class='p-3'>$product_description.</p>
                                <h4 class='mt-3'>Product Category:</h4>
                                <p class='p-3'>$category_title.</p>
                                <h4 class='mt-3'>Age:</h4>
                                <p class='p-3'>This Product is suitable for this $age years old of kids.</p>
                            </div>";
                            }
                        }

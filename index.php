...
<body>
  ...
  <div class="container-fluid p-0">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              ...
              if (isset($_SESSION['user_name'])) {
                echo "<a class='nav-link ' aria-current='page' href='./users_area/user_profile.php'>My&nbspAccount</a>";
              } else {
            ...
            <li class="nav-item">
              <a class="nav-link " aria-current="page" href="#">Total&nbsp;Price:&nbsp;<b><?php echo total_cart_price(); ?></b>/-</a>
            </li>
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="cart_details.php"><img src="./images/icons/cart.png" alt="Cart" class="cart"><sup> <strong><?php echo count_items_cart(); ?></strong></sup></a>
              </li>
            </ul>
    ...
    <!-- crousal image code -->
    <div class="container-fluid">
      <img src="./images/toy land banner 1.png" alt="" class="banner_image">
    </div>
          ...
          <div class="container-fluid bg-secondary p-0">
            ...
            <form action="" method="get">
              <select class="form-select bg-secondary text-center text-light mt-2 mb-2" aria-label="Default select example" name="sort">
                ...
                <option value="product_title" <?php if (isset($_GET['sort'])) {
                                                if ($_GET['sort'] === 'product_title') {
                                                  echo "selected";
                                                }
                                              } ?>>Sort by Name</option>
                <option value="product_price" <?php if (isset($_GET['sort'])) {
                                                if ($_GET['sort'] === 'product_price') {
                                                  echo "selected";
                                                }
                                              } ?>>Sort by Price</option>
                <option value="age" <?php if (isset($_GET['sort'])) {
                                      if ($_GET['sort'] === 'age') {
                                        echo "selected";
                                      }
                                    } ?>>Sort by Age</option>
                <option value="category_title" <?php if (isset($_GET['sort'])) {
                                                  if ($_GET['sort'] === 'category_title') {
                                                    echo "selected";
                                                  }
